  ...
  ((function () {
    ...
    t.prototype = {
        ...
        if (!(e._audioUnlocked || !e.ctx)) {
          ...
          var t = function (n) {
            ...
            ((c.buffer = e._scratchBuffer),
              ...
              c.start === void 0 ? c.noteOn(0) : c.start(0),
      ...
      _autoResume: function () {
        var e = this;
        if (!(!e.ctx || e.ctx.resume === void 0 || !n.usingWebAudio))
          return (
            e.state === `running` && e.ctx.state !== `interrupted` && e._suspendTimer
              ...
              : e.state === `suspended` || (e.state === `running` && e.ctx.state === `interrupted`)
                ? (e.ctx.resume().then(function () {
                  ...
                  (e._suspendTimer &&= (clearTimeout(e._suspendTimer), null)))
    ...
    r.prototype = {
      init: function (e) {
        ...
        return (
          ...
          (t._volume = e.volume === void 0 ? 1 : e.volume),
          (t._xhr = {
          ...
          n.ctx !== void 0 && n.ctx && n.autoUnlock && n._unlockAudio(),
          n._howls.push(t),
          t._autoplay &&
            t._queue.push({
              event: `play`,
      ...
      load: function () {
        ...
        return (
          (e._src = t),
          (e._state = `loading`),
          window.location.protocol === `https:` && t.slice(0, 5) === `http:` && ((e._html5 = !0), (e._webAudio = !1)),
          new i(e),
          e._webAudio && o(e),
          e
        );
      ...
      play: function (e, t) {
        ...
        if (typeof e == `number`) ((i = e), (e = null));
          ...
          for (var a = 0, o = 0; o < r._sounds.length; o++)
            r._sounds[o]._paused && !r._sounds[o]._ended && (a++, (i = r._sounds[o]._id));
          a === 1 ? (e = null) : (i = null);
        }
        ...
        if (r._webAudio) {
          var g = function () {
            ...
            (h.gain.setValueAtTime(e, n.ctx.currentTime),
              (s._playStart = n.ctx.currentTime),
              h.bufferSource.start === void 0
                ? s._loop
                  ? h.bufferSource.noteGrainOn(0, l, 86400)
                  : h.bufferSource.noteGrainOn(0, l, u)
                : s._loop
                  ? h.bufferSource.start(0, l, 86400)
                  : h.bufferSource.start(0, l, u),
              d !== 1 / 0 && (r._endTimers[s._id] = setTimeout(r._ended.bind(r, s), d)),
              t ||
                setTimeout(function () {
          ...
          var _ = function () {
            ((h.currentTime = l),
              (h.muted = s._muted || r._muted || n._muted || h.muted),
              (h.volume = s._volume * n.volume()),
              (h.playbackRate = s._rate));
            try {
              var i = h.play();
              if (
                (i && typeof Promise < `u` && (i instanceof Promise || typeof i.then == `function`)
                  ? ((r._playLock = !0),
                    m(),
                    i
                      .then(function () {
              ...
              e !== `__default` || s._loop
                ? (r._endTimers[s._id] = setTimeout(r._ended.bind(r, s), d))
      ...
      pause: function (e) {
        ...
        for (var n = t._getSoundIds(e), r = 0; r < n.length; r++) {
          ...
          if (
            i &&
            !i._paused &&
            ((i._seek = t.seek(n[r])), (i._rateSeek = 0), (i._paused = !0), t._stopFade(n[r]), i._node)
          )
            if (t._webAudio) {
              if (!i._node.bufferSource) continue;
              (i._node.bufferSource.stop === void 0 ? i._node.bufferSource.noteOff(0) : i._node.bufferSource.stop(0),
            ...
            a._node &&
              (n._webAudio
                ? a._node.bufferSource &&
                  (a._node.bufferSource.stop === void 0
      ...
      mute: function (e, t) {
        ...
        for (var i = r._getSoundIds(t), a = 0; a < i.length; a++) {
          ...
          o &&
            ((o._muted = e),
            o._interval && r._stopFade(o._id),
            r._webAudio && o._node
              ? o._node.gain.setValueAtTime(e ? 0 : o._volume, n.ctx.currentTime)
              : o._node && (o._node.muted = n._muted ? !0 : e),
            r._emit(`mute`, o._id));
        }
        return r;
      },
      volume: function () {
        ...
        t.length === 1 || (t.length === 2 && t[1] === void 0)
          ? e._getSoundIds().indexOf(t[0]) >= 0
            ? (i = parseInt(t[0], 10))
            : (r = parseFloat(t[0]))
          : t.length >= 2 && ((r = parseFloat(t[0])), (i = parseInt(t[1], 10)));
        var a;
        if (r !== void 0 && r >= 0 && r <= 1) {
            ...
            ((a = e._soundById(i[o])),
              a &&
                ...
                e._webAudio && a._node && !a._muted
                  ? a._node.gain.setValueAtTime(r, n.ctx.currentTime)
                  : a._node && !a._muted && (a._node.volume = r * n.volume()),
      ...
      loop: function () {
        ...
        for (var a = e._getSoundIds(r), o = 0; o < a.length; o++)
          ((i = e._soundById(a[o])),
            i &&
              ((i._loop = n),
              e._webAudio &&
        ...
        if (typeof r == `number`) {
          ...
          for (var o = 0; o < i.length; o++)
            if (((a = e._soundById(i[o])), a)) {
              (e.playing(i[o]) &&
                ((a._rateSeek = e.seek(i[o])), (a._playStart = e._webAudio ? n.ctx.currentTime : a._playStart)),
                (a._rate = r),
                e._webAudio && a._node && a._node.bufferSource
                  ? a._node.bufferSource.playbackRate.setValueAtTime(r, n.ctx.currentTime)
                  : a._node && (a._node.playbackRate = r));
              var s = e.seek(i[o]),
                c = (((e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - s) * 1e3) / Math.abs(a._rate);
              ((e._endTimers[i[o]] || !a._paused) &&
                (e._clearTimer(i[o]), (e._endTimers[i[o]] = setTimeout(e._ended.bind(e, a), c))),
                e._emit(`rate`, a._id));
            }
      ...
      seek: function () {
        ...
        if (
          (t.length === 0
            ? e._sounds.length && (i = e._sounds[0]._id)
            : t.length === 1
              ? e._getSoundIds().indexOf(t[0]) >= 0
                ? (i = parseInt(t[0], 10))
                : e._sounds.length && ((i = e._sounds[0]._id), (r = parseFloat(t[0])))
              : t.length === 2 && ((r = parseFloat(t[0])), (i = parseInt(t[1], 10))),
          i === void 0)
        )
          return 0;
        ...
        if (a)
          if (typeof r == `number` && r >= 0) {
            ...
            (o && e.pause(i, !0),
              ...
              (a._ended = !1),
              e._clearTimer(i),
              !e._webAudio && a._node && !isNaN(a._node.duration) && (a._node.currentTime = r));
            var s = function () {
      ...
      on: function (e, t, n, r) {
        var i = this,
          a = i[`_on` + e];
        return (typeof t == `function` && a.push(r ? { id: n, fn: t, once: r } : { id: n, fn: t }), i);
      },
      off: function (e, t, n) {
        var r = this,
          i = r[`_on` + e],
      ...
      _drain: function () {
        ...
        if (!(e._sounds.length < t)) {
          ...
          for (r = e._sounds.length - 1; r >= 0; r--) {
            if (n <= t) return;
            e._sounds[r]._ended &&
              (e._webAudio && e._sounds[r]._node && e._sounds[r]._node.disconnect(0), e._sounds.splice(r, 1), n--);
          }
        }
      },
      ...
      _refreshBuffer: function (e) {
        ...
        return (
          ...
          (e._node.bufferSource.buffer = a[t._src]),
    ...
    i.prototype = {
      ...
      create: function () {
        ...
        return (
          t._webAudio
            ? ((e._node = n.ctx.createGain === void 0 ? n.ctx.createGainNode() : n.ctx.createGain()),
      ...
      _loadListener: function () {
        ...
        ((t._duration = Math.ceil(e._node.duration * 10) / 10),
          Object.keys(t._sprite).length === 0 && (t._sprite = { __default: [0, t._duration * 1e3] }),
    ...
    var a = {},
      ...
      c = function (e, t) {
        ...
        typeof Promise < `u` && n.ctx.decodeAudioData.length === 1
          ? n.ctx.decodeAudioData(e).then(i).catch(r)
          : n.ctx.decodeAudioData(e, i, r);
      },
      l = function (e, t) {
        (t && !e._duration && (e._duration = t.duration),
          Object.keys(e._sprite).length === 0 && (e._sprite = { __default: [0, e._duration * 1e3] }),
      ...
      u = function () {
        if (n.usingWebAudio) {
          ...
          (n.usingWebAudio &&
            ((n.masterGain = n.ctx.createGain === void 0 ? n.ctx.createGainNode() : n.ctx.createGain()),
    ...
    (typeof define == `function` &&
      define.amd &&
      define([], function () {
        return { Howler: n, Howl: r };
      }),
      e !== void 0 && ((e.Howler = n), (e.Howl = r)),
      typeof global < `u`
        ? ((global.HowlerGlobal = t), (global.Howler = n), (global.Howl = r), (global.Sound = i))
        : typeof window < `u` &&
          ((window.HowlerGlobal = t), (window.Howler = n), (window.Howl = r), (window.Sound = i)));
  })(),
    (function () {
      ((HowlerGlobal.prototype._pos = [0, 0, 0]),
        ...
        (HowlerGlobal.prototype.pos = function (e, t, n) {
          ...
          if (
            ((t = typeof t == `number` ? t : r._pos[1]),
            (n = typeof n == `number` ? n : r._pos[2]),
            typeof e == `number`)
          )
            ((r._pos = [e, t, n]),
              r.ctx.listener.positionX === void 0
        ...
        (HowlerGlobal.prototype.orientation = function (e, t, n, r, i, a) {
          ...
          if (
            ((t = typeof t == `number` ? t : s[1]),
            (n = typeof n == `number` ? n : s[2]),
            (r = typeof r == `number` ? r : s[3]),
            (i = typeof i == `number` ? i : s[4]),
            (a = typeof a == `number` ? a : s[5]),
            typeof e == `number`)
          )
            ((o._orientation = [e, t, n, r, i, a]),
              o.ctx.listener.forwardX === void 0
                ? o.ctx.listener.setOrientation(e, t, n, r, i, a)
                : (o.ctx.listener.forwardX.setTargetAtTime(e, Howler.ctx.currentTime, 0.1),
                  o.ctx.listener.forwardY.setTargetAtTime(t, Howler.ctx.currentTime, 0.1),
                  o.ctx.listener.forwardZ.setTargetAtTime(n, Howler.ctx.currentTime, 0.1),
                  o.ctx.listener.upX.setTargetAtTime(r, Howler.ctx.currentTime, 0.1),
                  o.ctx.listener.upY.setTargetAtTime(i, Howler.ctx.currentTime, 0.1),
                  o.ctx.listener.upZ.setTargetAtTime(a, Howler.ctx.currentTime, 0.1)));
          else return s;
          return o;
        }),
        ...
        (Howl.prototype.pos = function (t, n, r, i) {
          ...
          if (((n = typeof n == `number` ? n : 0), (r = typeof r == `number` ? r : -0.5), i === void 0))
        ...
        (Howl.prototype.orientation = function (t, n, r, i) {
          ...
          if (
            ((n = typeof n == `number` ? n : a._orientation[1]),
            (r = typeof r == `number` ? r : a._orientation[2]),
            i === void 0)
          )
          ...
          for (var o = a._getSoundIds(i), s = 0; s < o.length; s++) {
            ...
            if (c)
              if (typeof t == `number`)
                ((c._orientation = [t, n, r]),
                  c._node &&
                    (c._panner || ((c._pos ||= a._pos || [0, 0, -0.5]), e(c, `spatial`)),
                    c._panner.orientationX === void 0
                      ? c._panner.setOrientation(t, n, r)
                      : (c._panner.orientationX.setValueAtTime(t, Howler.ctx.currentTime),
        ...
        (Howl.prototype.pannerAttr = function () {
            ...
            if (typeof n[0] == `object`)
              ((r = n[0]),
                i === void 0 &&
                  ...
                  (t._pannerAttr = {
                    coneInnerAngle:
                      r.pannerAttr.coneInnerAngle === void 0 ? t._coneInnerAngle : r.pannerAttr.coneInnerAngle,
                    coneOuterAngle:
                      r.pannerAttr.coneOuterAngle === void 0 ? t._coneOuterAngle : r.pannerAttr.coneOuterAngle,
                    coneOuterGain:
                      r.pannerAttr.coneOuterGain === void 0 ? t._coneOuterGain : r.pannerAttr.coneOuterGain,
                    distanceModel:
                      r.pannerAttr.distanceModel === void 0 ? t._distanceModel : r.pannerAttr.distanceModel,
                    ...
                    rolloffFactor:
                      r.pannerAttr.rolloffFactor === void 0 ? t._rolloffFactor : r.pannerAttr.rolloffFactor,
          ...
          for (var o = t._getSoundIds(i), s = 0; s < o.length; s++)
            if (((a = t._soundById(o[s])), a)) {
              ...
              var l = a._panner;
              ((l ||= ((a._pos ||= t._pos || [0, 0, -0.5]), e(a, `spatial`), a._panner)),
